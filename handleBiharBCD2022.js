async function handleBiharBCD2022(data, primary_table_name, itemNo) {
    console.log(data)
    var abstract_data = [];
            ...
            for (let j = i + 1; j < data.length; j++) {
                if (data[j].item_no.trim() === '') {
                    if (data[j].code.trim().toLowerCase().includes("unit :-") && data[j].code.trim().toLowerCase().includes("unit:-")) {
                        const tableName = "biharbcd2022itemsearch";
                        ...
                        if (checkDotNumbernAlpaOptional(data[j].code)) {
                            ...
                            let nestedItem = await handleNestedBiharBCD2022(dataNested, primary_table_name, mrate_table_name, lrate_table_name, data[j].code, isManualRateChecked, false, manualRates);
...
function initSORbiharBCD(head_item_no) {
    var itemSearch = getItemSearchData("biharbcd2022", head_item_no);
...
// async function handleNestedBiharBCD2022(data, primary_table_name, mrate_table_name, lrate_table_name, itemNo, isManualRateChecked, isCpohChecked, manualRates) {
//     console.log(isCpohChecked)
...
//                 return await handleBiharBCD2022(data, primary_table_name, mrate_table_name, lrate_table_name, data[i].code, isManualRateChecked, manualRates);
//             }
//             for (let j = i + 1; j < data.length; j++) {
//                 if (data[j].item_no.trim() === '') {
...
// async function captureCodesFromDataBiharBCD(ajaxCalls, data, primary_table_name, mrate_table_name, lrate_table_name, itemNo) {
...
//                                 await captureCodesFromLocalDatabiharbcd(sor, table, dataNested, data[i].code, primary_table_name, mrate_table_name, lrate_table_name);
//                                 continue;
//                             }
//                             for (let j = i + 1; j < data.length; j++) {
//                                 if (data[j].item_no.trim() === '') {
...
//                                         console.log(dataNested);
//                                         console.log(response);
//                                         await captureCodesFromLocalDatabiharbcd(sor, table, dataNested, data[j].code, primary_table_name, mrate_table_name, lrate_table_name);
//                                     }
...
//                                             console.log(res)
//                                             if (res != null) {
//                                                 await createInputFieldLocalbiharbcd(sor, table, data[j].code, data[j].description, res[2])
//                                             }

//                                         } else {
//                                             await createInputFieldLocalbiharbcd(sor, table, data[j].code, data[j].description, data[j].rate)
//                                         }
//                                     }
//                                     else if (data[j].code != null && data[j].code.trim() != '' && !data[j].code.trim().toLowerCase().includes('si')) {
//                                         if (mrate_table_name != null && mrate_table_name.trim() != '') {
//                                             const res = await getMaterialRate(mrate_table_name, data[j].code.trim());
//                                             if (res != null) {
//                                                 await createInputFieldLocalbiharbcd(sor, table, data[j].code, data[j].description, res[3])
//                                             }
...
// async function captureCodesFromLocalDatabiharbcd(sor, table, data, itemNo, primary_table_name, mrate_table_name, lrate_table_name) {
...
//     if (primary_table_name == "biharbcd2022") {
//         mainLoop: for (let i = 0; i < data.length; i++) {
//             if (data[i].item_no.trim() === itemNo.trim()) {
//                 if (data[i].item_no != null && data[i].item_no.trim() != '' && data[i + 1].item_no != null && data[i + 1].item_no.trim() != '') {
//                     console.log("single")
//                     console.log(data[i].item_no)
//                     await captureCodesFromLocalDatabiharbcd(sor, table, response, data[i].code);
//                     continue;
//                 }
//                 for (let j = i + 1; j < data.length; j++) {
//                     if (data[j].item_no.trim() === '') {
//                         if (data[j].code != null && data[j].code.trim() != '' && checkDotNumbernAlpaOptional(data[j].code)) {
//                             console.log("local nested filed created " + data[j].code)
//                             await captureCodesFromLocalDatabiharbcd(sor, table, response, data[j].code);
//                         }
//                         else if (data[j].code != null && data[j].code.trim() != '' && data[j].code.trim().toLowerCase().includes('si')) {
//                             if (mrate_table_name != null && mrate_table_name.trim() != '') {
//                                 const res = await getLabourRate(lrate_table_name, data[j].code.trim());
...
// async function createInputFieldLocalbiharbcd(sor, table, code, description, value) {
...
// async function handleBiharBCD2022(data, primary_table_name, lrate_table_name, mrate_table_name, lrate_table_default, mrate_table_default, itemNo, isManualRateChecked, isCpohChecked, manualRates) {
//     console.log(isCpohChecked)
//     console.log(data)
//     let xcell_data = [];
//     let xcell_data_nested = [];
...
//                 return await handleBiharBCD2022(dataSame, primary_table_name, mrate_table_name, lrate_table_name, data[i].code, isManualRateChecked, isCpohChecked, manualRates);
//             }
//             for (let j = i + 1; j < data.length; j++) {
//                 if (data[j].item_no.trim() === '') {
//                     if (data[j].code.trim().toLowerCase().includes("unit :-") && data[j].code.trim().toLowerCase().includes("unit:-")) {
